...
usage() {
  cat <<'EOF'
用法：
  ./scripts/build_ascend_detections_oms.sh ONNX_DIR OUTPUT_DIR BASE_MANIFEST

在 CANN 7.0.RC1 / Ascend310B1 上构建 P6 detections_v1 Base 和
Specialist OM。Scene OM 从已验证的 BASE_MANIFEST 复用；不会覆盖任何产物。
EOF
}
