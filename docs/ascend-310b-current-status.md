...
截至 2026-08-24，4+2 独立 YOLO26s 三-OM 方案已完成 mixed dev 约束校准、lock 冻结验收、不可变 release 物化、公共 `8501` 原子提升和部署后独立复验。Base mAP50、New-mAP50、KRR 和 FPS 四项赛题门禁均进入满分档。
...
20 图 batch 均使用 loopback HTTP multipart PNG、并发度 `1`、`30` 次预热和 `3×20` 图协议：
...
| 公共 `8501` 部署后 | `38.5802` | `38.6698` | `38.6623` | `38.6623` | PASS |
...
| 公共入口 | `127.0.0.1:8501` |
| 主实例 | `127.0.0.1:18501` |
| 回滚实例 | `20260823-4plus2-yolo26-content-gate-v2`，物理监听 `8501` |
